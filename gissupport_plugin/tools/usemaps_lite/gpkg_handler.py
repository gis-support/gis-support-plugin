...
class GpkgHandler:
    ...
    def extract_layer_to_temp_gpkg(self, source_uri: str, selected_layer_name: str):
        ...
        options.overrideGeometryType = QgsWkbTypes.dropM(QgsWkbTypes.dropZ(source_layer.wkbType()))
    ...
    def save_layer_to_temp_gpkg(self, layer: QgsVectorLayer, is_usemaps: bool = False) -> str:
        ...
        options = QgsVectorFileWriter.SaveVectorOptions()
        options.overrideGeometryType = QgsWkbTypes.dropM(QgsWkbTypes.dropZ(temp_layer.wkbType()))
