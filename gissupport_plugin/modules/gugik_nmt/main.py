...
class GugikNmt:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&GUGiK NMT')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'GugikNmt')
        self.toolbar.setObjectName(u'GugikNmt')

        #print "** INITIALIZING GugikNmt"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GugikNmt', message)
