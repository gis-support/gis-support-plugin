...
from .gissupport_plugin_dialog import GISSupportPluginDialog
import os.path
...
class GISSupportPlugin:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/gissupport_plugin/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Wtyczka GIS Support'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = GISSupportPluginDialog()
